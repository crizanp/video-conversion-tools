...
export default function MovToMp4Converter() {
    ...
    const handleFileSelect = (event) => {
        ...
        if (validFiles.length === 0) {
            setStatus('Please select valid MOV video files.');
            return;
        }
    ...
    const handleDrop = (e) => {
        ...
        if (validFiles.length === 0) {
            setStatus('Please drop valid MOV video files.');
            return;
        }
    ...
    const performConversion = async () => {
        if (selectedFiles.length === 0) {
            setStatus('Please select MOV files to convert.');
            return;
        }
    ...
    const featuresData = [
        {
            ...
            description: "Convert MOV files to MP4 in seconds with blazing-fast speed and zero quality loss.",
        },
        {
            icon: (
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            description: "Upload and convert multiple MOV files at once — batch processing made easy.",
        },
    ];
        ...
        <>
            ...
            <div className="bg-white min-h-screen flex flex-col items-start py-8 px-4">
                <div className="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto w-full">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-indigo-600 mb-4">
                                            Your MOV files have been successfully converted to MP4 format.
                                        </p>
                    ...
                    <FeaturesSection
                        title="Features"
                        description="Convert QuickTime MOV files to MP4 format with ease, speed, and premium quality."
